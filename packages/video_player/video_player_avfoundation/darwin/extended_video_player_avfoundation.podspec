...
#
Pod::Spec.new do |s|
  s.name             = 'extended_video_player_avfoundation'
  s.version          = '0.0.1'
...
Downloaded by pub (not CocoaPods).
  ...
  s.source_files = 'video_player_avfoundation/Sources/video_player_avfoundation/**/*.{h,m}', 'Classes/**/*'
  ...
  s.public_header_files = 'video_player_avfoundation/Sources/video_player_avfoundation/include/**/*.h', 'Classes/**/*.h'
